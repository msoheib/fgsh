-- ============================================================================
-- Migration: Fix voting system - prevent duplicate correct answer insertions
-- Date: 2024-11-29
-- Purpose: Ensure correct answer is only inserted once during answering→voting
-- ============================================================================
...
COMMENT ON FUNCTION advance_round_if_ready IS
  'Automatically advances round phases when all connected players have submitted. Prevents duplicate correct answers.';
...
COMMENT ON FUNCTION force_advance_round IS
  'Forces round to advance when timer expires. Prevents duplicate correct answers.';
