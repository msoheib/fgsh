...
- Started: 2026-05-28T19:20:08.738Z
- Completed: 2026-05-28T19:32:31.368Z
...
| --- | --- | ---: | --- |
| Deterministic vote registration and scoring | PASS | 20978 | All 3 votes persisted exactly once and scores matched expected totals (VoteScore P01:500, VoteScore P02:500, VoteScore P03:1000). |
| Near-timeout selected vote must persist or clear cleanly | FAIL | 69970 | Reproduced vote UI mismatch: answer was visibly selected near timer zero, but no vote row persisted. |
| Answer timer reaches zero with active controller | PASS | 86505 | Answer timer reached zero with active controller and advanced to voting. |
| Answer timer reaches zero with frozen controller | PASS | 88459 | Frozen controller did not stall answer timer; round advanced to voting. |
| Answer timer with controller force-advance RPC blocked | FAIL | 88192 | Reproduced timer dependency: controller stayed connected but its force-advance RPC was blocked, another player was active, and the round remained answering after deadline. |
| Voting timer reaches zero with active controller | PASS | 75853 | Voting timer reached zero with active controller and advanced to completed. |
| Play Again leaver can rejoin same lobby | FAIL | 291595 | Reproduced Play Again leaver rejoin failure. Saved session present after leave: true. URL: https://fgsh-web.vercel.app/join?code=PC0M13. Text: انضم إلى اللعبة<br>الكود: PC0M13<br>أدخل اسمك<br>الاسم مستخدم بالفعل<br>بدأ اللعبة<br>العودة |
| Long question and answer text does not overlap or clip | FAIL | 20828 | Mobile answer overflow/clipping detected (button1 scroll=547x48 client=288x48; button2 scroll=547x48 client=288x48) |
...
| Replay P02 | requestfailed |  | https://yabticelgerjwzrhyaye.supabase.co/rest/v1/players?select=*&game_id=eq.35b2b62f-5612-4e51-b1f2-41d8e0befcb3&order=joined_at.asc | net::ERR_ABORTED |
| Replay P02 | requestfailed |  | https://yabticelgerjwzrhyaye.supabase.co/rest/v1/rpc/reconnect_player_session | net::ERR_ABORTED |
| Replay P02 | console |  | https://fgsh-web.vercel.app/ | [error] [rehydrate] Failed to rehydrate session: GameError: TypeError: Failed to fetch<br>    at gt.getGamePlayers (https://fgsh-web.vercel.app/assets/index-731ac0ea.js:285:45755)<br>    at async rehydrateSession (https://fgsh-web.vercel.app/assets/index-731ac0ea.js:301:26240) |
...
| Replay P02 | console |  | https://fgsh-web.vercel.app/join?code=PC0M13 | [error] Failed to load resource: the server responded with a status of 400 () |
| Replay P02 | console |  | https://fgsh-web.vercel.app/join?code=PC0M13 | [error] Failed to join game: GameError: الاسم مستخدم بالفعل<br>    at gt.joinGame (https://fgsh-web.vercel.app/assets/index-731ac0ea.js:285:44259)<br>    at async joinGame (https://fgsh-web.vercel.app/assets/index-731ac0ea.js:301:17010)<br>    at async f (https://fgsh-web.vercel.app/assets/index-731ac0ea.js:374:10025) |
...
- Play Again leaver can rejoin same lobby: Reproduced Play Again leaver rejoin failure. Saved session present after leave: true. URL: https://fgsh-web.vercel.app/join?code=PC0M13. Text: انضم إلى اللعبة
الكود: PC0M13
أدخل اسمك
الاسم مستخدم بالفعل
بدأ اللعبة
