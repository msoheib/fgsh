...
- Started: 2026-05-10T12:52:31.297Z
- Completed: 2026-05-10T12:54:07.765Z
- Browser: chromium
...
| Host can log in and create a TV room | PASS | Created TV room XHJHNE. |
...
| --- | --- | ---: | --- | --- |
| create room | host | 3792 | PASS | Created TV room XHJHNE. |
| join | Stress P01 | 2361 | PASS |  |
| join | Stress P05 | 2453 | PASS |  |
| join | Stress P06 | 2463 | PASS |  |
| join | Stress P10 | 2450 | PASS |  |
| join | Stress P07 | 2511 | PASS |  |
| join | Stress P02 | 2554 | PASS |  |
| join | Stress P03 | 2571 | PASS |  |
| join | Stress P04 | 2589 | PASS |  |
| join | Stress P09 | 2588 | PASS |  |
| join | Stress P08 | 2788 | PASS |  |
| start game | Stress P01 | 25197 | PASS |  |
| answer | Stress P01 | 233 | PASS |  |
| answer | Stress P09 | 229 | PASS |  |
| answer | Stress P05 | 334 | PASS |  |
| answer | Stress P06 | 334 | PASS |  |
| answer | Stress P02 | 339 | PASS |  |
| answer | Stress P07 | 336 | PASS |  |
| answer | Stress P08 | 335 | PASS |  |
| answer | Stress P10 | 335 | PASS |  |
| answer | Stress P03 | 341 | PASS |  |
| answer | Stress P04 | 341 | PASS |  |
| total | all | 96467 | FAIL | [2mexpect([22m[31mreceived[39m[2m).[22mtoBeGreaterThan[2m([22m[32mexpected[39m[2m)[22m<br><br>Expected: > [32m1[39m<br>Received:   [31m1[39m<br><br>Call Log:<br>- Timeout 60000ms exceeded while waiting on the predicate |

## Diagnostics

- Console/page/request records captured: 304
