...
- Started: 2026-05-08T21:44:30.070Z
- Completed: 2026-05-08T21:46:29.497Z
- Browser: chromium
...
| Host can log in and create a TV room | PASS | Created TV room K5WMHZ. |
...
| No unexpected TV category-selection flash after answering begins | FAIL | 2 unexpected TV category-selection wait sample(s) observed after answering began. |
...
| --- | --- | ---: | --- | --- |
| create room | host | 3795 | PASS | Created TV room K5WMHZ. |
| join | Stress P01 | 2255 | PASS |  |
| join | Stress P07 | 2412 | PASS |  |
| join | Stress P04 | 2599 | PASS |  |
| join | Stress P03 | 2615 | PASS |  |
| join | Stress P02 | 2647 | PASS |  |
| join | Stress P06 | 2633 | PASS |  |
| join | Stress P08 | 2646 | PASS |  |
| join | Stress P09 | 2643 | PASS |  |
| join | Stress P10 | 2697 | PASS |  |
| join | Stress P05 | 2726 | PASS |  |
| start game | Stress P01 | 26499 | PASS |  |
| answer | Stress P10 | 148 | PASS |  |
| answer | Stress P06 | 152 | PASS |  |
| answer | Stress P03 | 155 | PASS |  |
| answer | Stress P05 | 155 | PASS |  |
| answer | Stress P04 | 157 | PASS |  |
| answer | Stress P07 | 156 | PASS |  |
| answer | Stress P08 | 156 | PASS |  |
| answer | Stress P02 | 162 | PASS |  |
| answer | Stress P01 | 178 | PASS |  |
| answer | Stress P09 | 172 | PASS |  |
| vote | Stress P01 | 131 | PASS |  |
| vote | Stress P02 | 152 | PASS |  |
| vote | Stress P09 | 145 | PASS |  |
| vote | Stress P05 | 150 | PASS |  |
| vote | Stress P03 | 166 | PASS |  |
| vote | Stress P07 | 173 | PASS |  |
| vote | Stress P06 | 175 | PASS |  |
| vote | Stress P04 | 184 | PASS |  |
| vote | Stress P08 | 182 | PASS |  |
| vote | Stress P10 | 181 | PASS |  |
| total | all | 119244 | FAIL |  |
| total | all | 119427 | FAIL | stress-test acceptance status<br><br>[2mexpect([22m[31mreceived[39m[2m).[22mtoBe[2m([22m[32mexpected[39m[2m) // Object.is equality[22m<br><br>Expected: [32m"pass"[39m<br>Received: [31m"fail"[39m |

## Diagnostics

- Console/page/request records captured: 319
